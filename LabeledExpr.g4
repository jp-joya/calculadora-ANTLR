...
expr: expr op=('*'|'/') expr     // Expresiones con operadores de multiplicación o división
    | expr op=('+'|'-') expr     // Expresiones con operadores de suma o resta
    | expr op='^' expr           // Expresión con operador de potenciación
